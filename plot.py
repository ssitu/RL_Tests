...
class Plot:
    ...
    def __init__(self, title, x_label, y_label, moving_average_length=500, update_interval=0.01):
        self.__title = title
    ...
    def save(self, name="plot"):
        ...
        self.__figure.savefig(f"./{name}", bbox_inches="tight")
